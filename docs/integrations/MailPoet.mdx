...
slug: /mailpoet/
title: MailPoet
description: Embed personalized, one-click magic-link logins in MailPoet email campaigns with the Simple JWT Login MailPoet add-on.
keywords: [MailPoet, magic link login, WordPress email, JWT authentication, autologin]
sidebar_position: 1
author: Nicu Micle
