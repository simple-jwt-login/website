...
title: Shortcode
description: Configure the "Continue with Google" button shortcode options for Simple JWT Login's Google OAuth integration.
keywords: [Google login shortcode, WordPress shortcode, OAuth, social login]
sidebar_position: 5
author: Nicu Micle
