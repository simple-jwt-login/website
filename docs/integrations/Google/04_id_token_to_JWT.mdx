...
description: Exchange a Google id_token for a WordPress JWT, completing Google Sign-In authentication with Simple JWT Login.
keywords: [Google id_token, WordPress JWT, OAuth, social login, JWT authentication]
sidebar_position: 4
author: Nicu Micle
