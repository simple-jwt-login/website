...
description: Exchange a Google OAuth authorization code for an access_token or id_token using Simple JWT Login.
keywords: [Google OAuth, id_token, access_token, OAuth code exchange, JWT authentication]
sidebar_position: 3
author: Nicu Micle
