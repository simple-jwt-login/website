...
title: Setup
description: Create a Google Developer Console project and obtain OAuth credentials for Google Sign-In with Simple JWT Login.
keywords: [Google OAuth, Google Developer Console, WordPress, JWT authentication]
sidebar_position: 1
author: Nicu Micle
...
![WordPress Google Settings](/assets/images/screenshots/oauth/app_google_settings.png)
