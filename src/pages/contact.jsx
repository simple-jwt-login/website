...
const channels = [
  {
    ...
    description: 'The fastest way to get an answer. Ask questions, share ideas, and chat with the maintainer and other users in real time.',
    cta: 'Join the server',
  ...
  },
  {
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" width="28" height="28" aria-hidden="true">
        <path d="M21.469 6.825l-3.937 3.936a1.5 1.5 0 0 0 0 2.122l3.937 3.937a.75.75 0 0 1-1.061 1.06l-3.937-3.937a3 3 0 0 1 0-4.243l3.937-3.937a.75.75 0 1 1 1.061 1.062zm-18.938 0a.75.75 0 0 1 1.062-1.062l3.937 3.937a3 3 0 0 1 0 4.243l-3.937 3.937a.75.75 0 0 1-1.062-1.06l3.937-3.937a1.5 1.5 0 0 0 0-2.122L2.531 6.825zM13.12 3.28a.75.75 0 0 1 .6.879l-3 12a.75.75 0 1 1-1.46-.36l3-12a.75.75 0 0 1 .86-.519z"/>
      </svg>
    ),
    label: 'WordPress Forum',
    title: 'Plugin support forum',
    description: "The official WordPress.org support forum for Simple JWT Login. Great for plugin-specific questions that the broader WordPress community can benefit from.",
    cta: 'Visit the forum',
        ...
        <section className={styles.section}>
          <div className="container">
            <div className={styles.grid}>
              {channels.map((ch) => (
                <div key={ch.label} className={styles.card} style={{'--accent': ch.accent}}>
                  {ch.recommended && (
                    <div className={styles.badge}>Fastest response</div>
                  )}
                  <div className={styles.iconWrap} style={{color: ch.accent}}>
                    {ch.icon}
                  </div>
                  <div className={styles.cardLabel}>{ch.label}</div>
